...
int main(int argc,char** argv){
    ...
    if(num_meth == 1){
        printf("\nVous avez choisi la méthode 1 avec liste chaînée.\n");
        ...
        printf("\nVous avez choisi la méthode 2 avec table de hachage.\n");
        ...
        printf("\nVous avez choisi la méthode 3 avec arbre quaternaire.\n");
